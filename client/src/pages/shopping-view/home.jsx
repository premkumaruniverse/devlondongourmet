...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-gray-900 mb-4 dark:text-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 perspective-1000">
            {experienceBrands.map((brand, index) => (
              <Card 
                key={brand.id} 
                className="p-8 text-center hover:shadow-2xl transition-shadow transform-gpu hover-tilt-strong hover-glow-3d dark:bg-gray-900 dark:border-gray-800"
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-3 dark:text-white" style={brandTransforms[index]?.content}>{brand.name}</h3>
                <p className="text-gray-600 mb-6 dark:text-gray-400" style={brandTransforms[index]?.content}>{brand.description}</p>
                <Button 
                  variant="outline" 
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-gray-900 mb-6 dark:text-white">
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold dark:text-white">Chef-Driven Creativity</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold dark:text-white">Farm-to-Fork</h4>
      ...
      <section className="py-20 bg-amber-50 dark:bg-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-gray-900 mb-4 dark:text-white">
          ...
          <div className="grid md:grid-cols-3 gap-8 perspective-1000">
            {testimonials.map((testimonial, index) => (
              <Card 
                key={testimonial.id} 
                className="p-8 text-center hover:shadow-2xl transition-shadow h-full flex flex-col transform-gpu hover-tilt-strong hover-glow-3d dark:bg-gray-900 dark:border-gray-800"
              ...
              >
                ...
                <blockquote className="text-gray-700 italic mb-6 flex-grow dark:text-gray-300" style={testimonialTransforms[index]?.content}>
                  {testimonial.quote}
                </blockquote>
                <div>
                  <p className="font-semibold dark:text-white" style={testimonialTransforms[index]?.content}>{testimonial.author}</p>
