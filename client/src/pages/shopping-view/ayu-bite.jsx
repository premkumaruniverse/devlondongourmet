  ...
  return (
    <div className="container mx-auto px-4 py-12 dark:bg-gray-950 dark:text-white">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-4 dark:text-white">Ayu Bite</h1>
        <p className="text-xl text-gray-600 dark:text-gray-300">Nourish Your Body, Delight Your Senses</p>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="bg-white dark:bg-gray-900 dark:border dark:border-gray-800 rounded-lg shadow-md p-6">
          <h2 className="text-2xl font-semibold mb-4 dark:text-white">Our Approach</h2>
        ...
        <div className="bg-white dark:bg-gray-900 dark:border dark:border-gray-800 rounded-lg shadow-md p-6">
          <h2 className="text-2xl font-semibold mb-4 dark:text-white">Popular Meal Plans</h2>
          ...
          <Button variant="outline" className="w-full mt-4 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700">View All Plans</Button>
        </div>
      </div>

      <div className="bg-amber-50 dark:bg-gray-900/50 p-8 rounded-lg mb-12">
        <h2 className="text-2xl font-semibold mb-6 text-center dark:text-white">Subscribe & Save</h2>
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {[
            ...
            <div 
              key={index} 
              className={`bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md border-2 ${plan.popular ? 'border-amber-400 transform scale-105' : 'border-transparent dark:border-gray-800'}`}
            >
              {plan.popular && (
              ...
              <p className="text-3xl font-bold mb-2 dark:text-white">£{plan.price}<span className="text-sm font-normal text-gray-500 dark:text-gray-400">/week</span></p>
              ...
              <Button className={`w-full ${plan.popular ? 'bg-amber-600 hover:bg-amber-700 text-white' : ''}`}>
                Get Started
              </Button>
            </div>
          ))}
