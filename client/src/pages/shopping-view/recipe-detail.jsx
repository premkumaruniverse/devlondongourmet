...
const RecipeDetail = () => {
  ...
  if (!recipeDetails) {
    return (
      <div className="container mx-auto px-4 py-12">
        <div className="text-center">
          <h1 className="text-2xl font-semibold text-gray-600 mb-4">Recipe not found</h1>
          <Button onClick={() => navigate('/shop/recipes')} variant="outline">
            Back to Recipes
          </Button>
        </div>
      </div>
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div className="flex items-center space-x-2 bg-gray-50 p-4 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">{recipeDetails.totalTime || recipeDetails.prepTime || 'N/A'}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2 bg-gray-50 p-4 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">{recipeDetails.servings || 'N/A'}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2 bg-gray-50 p-4 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">{recipeDetails.difficulty || 'N/A'}</p>
                  </div>
                </div>
              </div>
            )}
                ...
                {recipeDetails.tags && recipeDetails.tags.length > 0 && (
                  <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    {recipeDetails.tags.map((tag, index) => (
                      <span
                        key={index}
                        className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-amber-50 to-orange-50 text-amber-800 border border-amber-200 hover:from-amber-100 hover:to-orange-100 transition-colors duration-200"
                      >
                        #{tag}
                      </span>
                    ))}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {/* Main Content */}
          <div className={`bg-white rounded-lg shadow-lg p-6 ${recipeDetails.type === 'recipe' ? '' : 'md:col-span-2'}`}>
            <h2 className="text-2xl font-bold mb-4 flex items-center">
              <BookOpen className="w-6 h-6 mr-2 text-amber-600" />
